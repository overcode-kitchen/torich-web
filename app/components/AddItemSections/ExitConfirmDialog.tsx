      ...
      <div className="relative z-[60] w-full max-w-md mx-4 bg-card rounded-2xl shadow-lg p-6">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 py-3 text-body font-medium text-foreground-soft bg-secondary rounded-xl hover:bg-surface-strong transition-colors"
          >
            계속하기
          </button>
          <button
            type="button"
            onClick={onConfirm}
            className="flex-1 py-3 text-body font-medium text-white bg-destructive rounded-xl hover:bg-destructive/90 transition-colors"
          >
            그만두기
          </button>
        </div>
