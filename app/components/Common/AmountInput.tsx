    ...
    <div>
      <div className="relative">
        <input
          ...
          onChange={onChange}
          placeholder="0"
          className="w-full h-16 rounded-xl bg-field-bg px-4 pr-16 text-2xl font-bold text-center tracking-tight text-foreground placeholder:text-foreground-subtle border-0 focus:outline-none focus:ring-2 focus:ring-ring/60 transition-all"
        />
