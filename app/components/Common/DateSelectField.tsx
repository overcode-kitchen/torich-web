...
export default function DateSelectField({
  ...
  const buttonClass =
    variant === 'flow'
      ? 'w-full flex items-center justify-between bg-field-bg rounded-xl h-12 px-4 text-base text-foreground border-0 hover:brightness-95 focus:outline-none focus:ring-2 focus:ring-ring/60 transition-all disabled:opacity-50'
