  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <p
          id="rich-quote-title"
          className="text-caption font-semibold uppercase tracking-wider text-white/70"
        >
          오늘의 부자 명언
        </p>
      </div>
      ...
      <button
        type="button"
        onClick={onShare}
        className="self-start inline-flex items-center gap-2 rounded-xl border border-white/15 bg-white/10 px-4 py-2 text-label font-medium text-white transition-colors hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
        aria-label="명언 공유하기"
      >
